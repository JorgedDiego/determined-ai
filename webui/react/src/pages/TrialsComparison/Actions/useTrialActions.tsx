...
const useTrialActions = ({
  ...
  const previousFilters = usePrevious(filters, undefined);
  ...
  useEffect(() => {
    if (previousFilters && (JSON.stringify(filters) !== JSON.stringify(previousFilters)))
      clearSelected();
  }, [ clearSelected, filters, previousFilters ]);
